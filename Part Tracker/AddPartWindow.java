...
public class AddPartWindow {
    ...
    public AddPartWindow(Stage primaryStage){
...
//MIDDLE
        ...
        TextField idText = new TextField("Auto Gen - Disbled");
        idText.setDisable(true);
        TextField nameText = new TextField("Part Name");            
        TextField invText = new TextField("Inv"); 
        TextField priceText = new TextField("Price/Cost");
...
//Button action handlers
        ...
        saveBtn.setOnAction((ActionEvent e) -> {
            ...
            if(validationErrorsList.size()>0){
                ...
                if(inHouse.isSelected()){
                    InHouse inHousePart = new InHouse(nameText.getText(), invValue, prcValue, minValue, maxValue, machValue);
                    ...
                    OutSourced outSourcedPart = new OutSourced(nameText.getText(), invValue, prcValue, minValue, maxValue, companyText.getText());
        ...
        cancelBtn.setOnAction((ActionEvent e) -> {
            int choice = JOptionPane.showConfirmDialog(null, "Are you sure you want to exit Add Part Window?", "CAUTION!", JOptionPane.OK_CANCEL_OPTION);            
            if(choice == 0){                    
                inventory.resetProductList();
                inventory.resetPartList();
